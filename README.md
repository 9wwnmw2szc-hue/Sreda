...
Этап 4: серверные аккаунты и бизнесы на PostgreSQL, вход по email-коду. Telegram/VK, заявки и платежи ещё не подключены. Инструкция запуска и границы проверки: [STAGE4.md](docs/architecture/STAGE4.md).
