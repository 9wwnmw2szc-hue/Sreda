...
export async function telegramCall(token:string,method:"getFile"|"sendMessage"|"setWebhook"|"getMe"|"getChat"|"getChatMember",body:Record<string,unknown>,transport:typeof fetch=fetch) {
 try {
