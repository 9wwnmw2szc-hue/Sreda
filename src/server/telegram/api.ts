...
export class TelegramError extends AppError {
 constructor(public retryAfter=0,public permanent=false,public chatUnavailable=false){super(503,"TELEGRAM_UNAVAILABLE","Telegram не подтвердил действие. Попробуйте позже.");}
}
export async function telegramCall(token:string,method:"sendMessage"|"setWebhook",body:Record<string,unknown>,transport:typeof fetch=fetch) {
 ...
 }catch(e){if(e instanceof TelegramError)throw e;throw new TelegramError();}
}
