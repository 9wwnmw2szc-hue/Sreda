...
export const FIELD_HINTS = {
  ...
  scheduleModeAuto:
    "Укажите рабочие дни и часы. БизнеСоты рассчитают свободное время с учётом длительности услуг, перерывов, записей, выходных и отпусков.",
  scheduleModeManual:
    "Вы сами добавляете свободные окна. Подходит, если расписание каждый день разное.",
  greeting:
    "Первое сообщение, которое клиент увидит в боте вашего бизнеса — не сервиса «БизнеСоты».",
  aiRestrictions:
